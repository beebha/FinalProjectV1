		...
		<div data-role="content">
			...
			<ul data-role="listview" data-split-icon="gear" data-filter="true">
				<g:each in="${surveyInstanceList}" status="i" var="surveyInstance">
					<li>
						<g:link action="show" id="${surveyInstance.id}">${surveyInstance}</g:link>
						<g:link action="edit" id="${surveyInstance.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
					</li>
				</g:each>
			</ol>
