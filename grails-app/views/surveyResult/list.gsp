		...
		<div data-role="content">
			...
			<ul data-role="listview" data-split-icon="gear" data-filter="true">
				<g:each in="${surveyResultInstanceList}" status="i" var="surveyResultInstance">
					<li>
						<g:link action="show" id="${surveyResultInstance.id}">${surveyResultInstance}</g:link>
						<g:link action="edit" id="${surveyResultInstance.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
					</li>
				</g:each>
			</ol>
