		...
		<div data-role="content">
			...
			<ul data-role="listview" data-split-icon="gear" data-filter="true">
				<g:each in="${questionInstanceList}" status="i" var="questionInstance">
					<li>
						<g:link action="show" id="${questionInstance.id}">${questionInstance}</g:link>
						<g:link action="edit" id="${questionInstance.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
					</li>
				</g:each>
			</ol>
