		...
		<div data-role="content">
			...
			<ul data-role="listview" data-split-icon="gear" data-filter="true">
				<g:each in="${answerInstanceList}" status="i" var="answerInstance">
					<li>
						<g:link action="show" id="${answerInstance.id}">${answerInstance}</g:link>
						<g:link action="edit" id="${answerInstance.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
					</li>
				</g:each>
			</ol>
