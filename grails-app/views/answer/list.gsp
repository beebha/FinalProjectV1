			...
			<table>
				<thead>
					<tr>
						...
						<th><g:message code="answer.optionSelected.label" default="Option Selected" /></th>
					
						<th><g:message code="answer.surveyResult.label" default="Survey Result" /></th>
				...
				<g:each in="${answerInstanceList}" status="i" var="answerInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${answerInstance.id}">${fieldValue(bean: answerInstance, field: "optionSelected")}</g:link></td>
					
						<td>${fieldValue(bean: answerInstance, field: "surveyResult")}</td>
