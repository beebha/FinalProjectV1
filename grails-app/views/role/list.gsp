		...
		<div data-role="content">
			...
			<ul data-role="listview" data-split-icon="gear" data-filter="true">
				<g:each in="${roleInstanceList}" status="i" var="roleInstance">
					<li>
						<g:link action="show" id="${roleInstance.id}">${roleInstance}</g:link>
						<g:link action="edit" id="${roleInstance.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
					</li>
				</g:each>
			</ol>
